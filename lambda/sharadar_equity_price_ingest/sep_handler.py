...
S3_PREFIX = os.getenv(
    "S3_PREFIX",
    "r_potential/dev/bronze/sep/incremental",
)

HISTORICAL_KEY = os.getenv(
    "HISTORICAL_KEY",
    "r_potential/parquet_output/SHARADAR_SEP.parquet",
)

INITIAL_LASTUPDATED = os.getenv(
    "INITIAL_LASTUPDATED",
    "2026-09-12",
)
...
def fetch_updates(
    ...
    for iteration in range(max_pages):
        ...
        # IMPORTANT:
        # meta is at the top-level payload, not inside datatable.
        ...
        print(
            f"Rows on page: {len(rows)}"
        )

        print(
            f"Next cursor exists: {bool(cursor_id)}"
        )
    ...
    print(
        f"Total fetched rows: {result.height}"
    )
...
# ============================================================
# MAX(lastupdated) FROM INCREMENTAL PARQUET
# ============================================================
...
def determine_prod_start_date():
    ...
    # One-day overlap protects against delayed revisions.
    # Bronze MERGE handles duplicate ticker/date rows.
    start_date = (
        max_lastupdated
        - timedelta(days=1)
    )
    ...
    print("")
    print("SEP production checkpoint:")
    print(
...
def lambda_handler(event, context):
    ...
    if run_mode == "job_test":
        ...
        print("")
        print("========================================")
        print("SEP DATABRICKS JOB TRIGGER TEST")
        print("========================================")
        print("Sharadar SEP fetch: DISABLED")
        print("S3 write: DISABLED")
        print("Databricks job trigger: ENABLED")
        print("========================================")
        print("")
    ...
    if run_mode == "auth_test":
        ...
        print("")
        print("========================================")
        print("SEP DATABRICKS AUTH TEST")
        print("========================================")
        print("Sharadar SEP fetch: DISABLED")
        print("S3 write: DISABLED")
        print("Databricks job trigger: DISABLED")
    ...
    if run_mode == "test":
        ...
        print("SEP TEST MODE")
        print("========================================")
        print("Checkpoint lookup: DISABLED")
        print("S3 write: DISABLED")
        print("Databricks trigger: DISABLED")
        print(
            f"Requested range: "
    ...
    print("")
    print("========================================")
    print("SEP PRODUCTION MODE")
    print("========================================")
    print("Checkpoint lookup: ENABLED")
    print("Checkpoint: MAX(lastupdated)")
    print("1-day overlap: ENABLED")
    print("S3 write: ENABLED")
    print("Databricks trigger: ENABLED")
    print("========================================")
    print("")
    ...
    if updates.is_empty():
        ...
        return {
            ...
            "body": json.dumps({
                "message":
                    "No SEP production updates found",
    ...
    print("")
    print(
        f"Wrote {updates.height} SEP rows"
    )
    print(
        f"s3://{S3_BUCKET}/{s3_key}"
    )
    ...
    print(
        "Triggering Databricks "
        "equity-price pipeline..."
    )
    ...
    return {
        ...
        "body": json.dumps({
            "message":
                "SEP production ingest complete",
